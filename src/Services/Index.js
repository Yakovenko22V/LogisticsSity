...
export const dataBasic = [
    ...
    { icon: Frame2, title: 'Спот-аукціони', parahraf1: 'Замінюємо пошту та месенджери.', parahraf2: 'Усі торги компанії в одному місці.', parahraf3: 'Закрийте регулярний рейс у пару кліків.', parahraf4: 'Чіткий контроль кола учасників.', parahraf5: 'Різні типи аукціонів під будь-яку ситуацію.' },
